...
public class HW001 {
	...
	public static void main(String[] args) {
		...
		if (counterForFirstNumber > counterForSecondNumber) {
			System.out.println("Dizide " + firstNumber + " sayısı " + secondNumber + " sayısından daha fazladır. " + counterForFirstNumber + " kere geçmektedir.");
		}
		else if (counterForSecondNumber > counterForFirstNumber){
			System.out.println("Dizide " + secondNumber + " sayısı " + firstNumber + " sayısından daha fazladır. " + counterForSecondNumber + " kere geçmektedir.");
		}
		else {
			System.out.println("Dizide " + firstNumber + " sayısı ve " + secondNumber + " sayısı eşit sayıda geçmektedir. " + counterForSecondNumber + " kere geçmektedir.");
		}
		...
		int array3[] = { 1, 13, 5, 13, 2, 5, 7, 1, 13, 13, 8, 13, 25, 21 };
